...
// in simulator we redefine to format for webcapsule_mobile Developer console
...
{\
	NSString * exceptionName = [@"org.webcapsule_mobile." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.webcapsule_mobile";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIwebcapsule_mobileNativeItemNone = -1, 
	UIwebcapsule_mobileNativeItemSpinner = -2,
	UIwebcapsule_mobileNativeItemProgressBar = -3,
	
	UIwebcapsule_mobileNativeItemSlider = -4,
	UIwebcapsule_mobileNativeItemSwitch = -5,
	UIwebcapsule_mobileNativeItemMultiButton = -6,
	UIwebcapsule_mobileNativeItemSegmented = -7,
	
	UIwebcapsule_mobileNativeItemTextView = -8,
	UIwebcapsule_mobileNativeItemTextField = -9,
	UIwebcapsule_mobileNativeItemSearchBar = -10,
	
	UIwebcapsule_mobileNativeItemPicker = -11,
	UIwebcapsule_mobileNativeItemDatePicker = -12,
	
	UIwebcapsule_mobileNativeItemInfoLight = -13,
	UIwebcapsule_mobileNativeItemInfoDark = -14,
	
	UIwebcapsule_mobileNativeItemDisclosure = -15,
	
	UIwebcapsule_mobileNativeItemContactAdd = -16
};
